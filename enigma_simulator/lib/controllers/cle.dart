...
class Cle{
  ...
  const Cle({this.order = const [1, 2, 3],this.routations = const [0, 0, 0],this.directions= const [1,1,1] });
  ...
  int getRoutersRotation({int router = 1}){
    return this.routations[this.order.indexOf(router)] * this.directions[this.order.indexOf(router)];
  }
